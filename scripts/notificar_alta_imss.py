...
LOG_FILE = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'logs', 'tareas_notificacion.log')
logging.basicConfig(
...
def run():
    log.info('==== INICIO NOTIFICACION ALTA IMSS ====')
    conn = get_connection()
    ...
    log.info('==== FIN NOTIFICACION ALTA IMSS ====')
    conn.close()
