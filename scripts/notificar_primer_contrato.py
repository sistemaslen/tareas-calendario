...
LOG_FILE = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'logs', 'tareas_primer_contrato_notificacion.log')
logging.basicConfig(
...
TASK_CODE = 'PRIMER_CONTRATO'


def run():
    log.info('==== INICIO NOTIFICACION PRIMER CONTRATO ====')
    conn = get_connection()
    ...
    log.info('==== FIN NOTIFICACION PRIMER CONTRATO ====')
    conn.close()
