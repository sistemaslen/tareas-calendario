...
LOG_FILE = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'logs', 'tareas_segundo_contrato_notificacion.log')
logging.basicConfig(
...
TASK_CODE = 'SEGUNDO_CONTRATO'


def run():
    log.info('==== INICIO NOTIFICACION SEGUNDO CONTRATO ====')
    conn = get_connection()
    ...
    log.info('==== FIN NOTIFICACION SEGUNDO CONTRATO ====')
    conn.close()
